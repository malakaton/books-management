 ...
 */
class BooksManagement_App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'BooksManagement\\Book\\EntryPoint\\Http\\Controller\\CreateBookController' => 'getCreateBookControllerService',
            'BooksManagement\\Book\\EntryPoint\\Http\\Controller\\GetBookByIdController' => 'getGetBookByIdControllerService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['BooksManagement\\Shared\\Infrastructure\\Symfony\\Exception\\ApiExceptionListener'] ?? ($this->privates['BooksManagement\\Shared\\Infrastructure\\Symfony\\Exception\\ApiExceptionListener'] = new \BooksManagement\Shared\Infrastructure\Symfony\Exception\ApiExceptionListener()));
    ...
    {
        return $this->privates['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener(($this->services['router'] ?? $this->getRouterService()), ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), ($this->privates['router.request_context'] ?? $this->getRouter_RequestContextService()), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), \dirname(__DIR__, 3), true);
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/BooksManagement_App_KernelDevDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'BooksManagement_App_KernelDevDebugContainer',
            ...
            'doctrine.dbal.connection_factory.types' => [
                'book_uuid' => [
                    'class' => 'BooksManagement\\Book\\Infrastructure\\Persistence\\Doctrine\\BookUuidType',
                ],
                'author_uuid' => [
                    'class' => 'BooksManagement\\Author\\Infrastructure\\Persistence\\Doctrine\\AuthorUuidType',
                ],
            ],
